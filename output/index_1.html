...
<div class="w3-dark-grey w3-center w3-padding-large w3-padding-48" style="padding-bottom:68px!important">
  ...
  <div class="w3-third">
  <p><a class="w3-btn w3-green w3-block w3-padding-16" xstyle="max-width:300px" href="/html/exercise.asp" target="_blank">HTML Exercises &raquo;</a></p>
  </div>
  <div class="w3-third">
  <p><a class="w3-btn w3-green w3-block w3-padding-16" href="/css/exercise.asp" target="_blank">CSS Exercises &raquo;</a></p>
  </div>
  <div class="w3-third">
  <p><a class="w3-btn w3-green w3-block w3-padding-16" href="/js/exercise_js.asp?filename=exercise_js_variables1" target="_blank">JavaScript Exercises &raquo;</a></p>
  </div>
  </div>
</div>
