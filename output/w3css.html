...
<div class="w3-green w3-center w3-margin-top w3-padding-16">
<h1>
W3.CSS<br>
...
<a class="w3-bar-item w3-button w3-mobile" href="tryit.asp?filename=tryw3css_templates_gourmet_catering&stacked=h" target="_blank">Demo 1</a>
<a class="w3-bar-item w3-button w3-mobile" href="tryit.asp?filename=tryw3css_templates_band&stacked=h" target="_blank">Demo 2</a>
<a class="w3-bar-item w3-button w3-mobile" href="tryit.asp?filename=tryw3css_templates_wedding&stacked=h" target="_blank">Demo 3</a>
<a class="w3-bar-item w3-button w3-mobile" href="tryit.asp?filename=tryw3css_templates_parallax" target="_blank">Demo 4</a>
</div>
<hr>
...
<ul class="w3-leftbar w3-theme-border w3-padding-16" style="list-style:none">
 ...
 <li>Better cross-browser compatibility than other CSS frameworks.</li>
  ...
  <li>Provides CSS equality for all browsers: Chrome, Firefox, Edge, IE, Safari, Opera, 
  ...</li>
  <li>Provides CSS equality for all devices: desktop, laptop, tablet, and mobile.</li>
