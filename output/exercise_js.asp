<script>var exnames = [], excounts = [], exheadings = [];exnames[0] = 'js_variables';excounts[0] = '5';exheadings[0] = 'Variables';exActiveNo = 0;exnames[1] = 'js_operators';excounts[1] = '5';exheadings[1] = 'Operators';exnames[2] = 'js_functions';excounts[2] = '4';exheadings[2] = 'Functions';exnames[3] = 'js_objects';excounts[3] = '3';exheadings[3] = 'Objects';exnames[4] = 'js_events';excounts[4] = '3';exheadings[4] = 'Events';exnames[5] = 'js_strings';excounts[5] = '9';exheadings[5] = 'Strings';exnames[6] = 'js_arrays';excounts[6] = '8';exheadings[6] = 'Arrays';exnames[7] = 'js_dates';excounts[7] = '4';exheadings[7] = 'Dates';exnames[8] = 'js_math';excounts[8] = '4';exheadings[8] = 'Math';exnames[9] = 'js_comparisons';excounts[9] = '4';exheadings[9] = 'Comparisons';exnames[10] = 'js_conditions';excounts[10] = '2';exheadings[10] = 'Conditions';exnames[11] = 'js_switch';excounts[11] = '2';exheadings[11] = 'Switch';exnames[12] = 'js_loops';excounts[12] = '6';exheadings[12] = 'Loops';exnames[13] = 'js_dom_html';excounts[13] = '9';exheadings[13] = 'HTML DOM';</script>
<!DOCTYPE html>
<html lang="en-US">
<head>
...
function w3LoadExercise() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_js_variables1".replace("exercise_","");
...
function needHint(x) {
    ...
    <meta property="og:url" content="https://www.w3schools.com/JS/exercise.asp">
...
<!-- TryitLeaderboard -->
  ...
  <div>
    ...
    <div id="assignmenttext" style="display:none">
      <p>Create a variable called <code class="w3-codespan">carName</code>, assign the value <code class="w3-codespan">Volvo</code> to it.</p>
...
<div style="position:relative">
  ...
  <button id="showanswerbutton" class="w3-btn" style="position:absolute;right:20px;bottom:20px;padding:15px;" type="button" onclick="showanswer();snhb.startAuction(['try_it_leaderboard']);">Show Answer</button>
  <button id="hideanswerbutton" class="w3-btn" style="position:absolute;right:20px;bottom:20px;padding:15px;display:none;" type="button" onclick="hideanswer();snhb.startAuction(['try_it_leaderboard']);">Hide Answer</button>
</div>
...
function initAssignment() {
  var x, y, txt, i, newtxt, c, n, numberofchar, j, inputs, templates, l, inputcount = -1;
...
function checkassignmentcode() {
  var check, correct, correct2, inputs, i, moreCorrect = true, result = "";
...
function showanswer() {
  ...
  for (i = 0; i < correctpositions.length; i++) {
    ...
    if (z == "&") {
      if (correcttxt.substr(x, 4) == "&lt;") { z = "<"; cc = cc + 3; }
      if (correcttxt.substr(x, 4) == "&gt;") { z = ">"; cc = cc + 3; }
    }
...
<div><div onclick="openmenuitems(0)" class="exmenuitemheader active"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Variables </div><div class="exmenulinks active"><a class="exbtn active" href="exercise_js.asp?filename=exercise_js_variables1"><i class="fa fa-check active"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_variables2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_variables3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_variables4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_variables5"><i class="fa fa-check"></i> Exercise 5</a><a class="exbtn" href="js_variables.asp" style="font-size:80%;text-decoration:underline;">Go to JS Variables tutorial</a></div></div><div><div onclick="openmenuitems(1)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Operators </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_operators1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_operators2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_operators3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_operators4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_operators5"><i class="fa fa-check"></i> Exercise 5</a><a class="exbtn" href="js_operators.asp" style="font-size:80%;text-decoration:underline;">Go to JS Operators tutorial</a></div></div><div><div onclick="openmenuitems(2)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Functions </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_functions1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_functions2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_functions3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_functions4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="js_functions.asp" style="font-size:80%;text-decoration:underline;">Go to JS Functions tutorial</a></div></div><div><div onclick="openmenuitems(3)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Objects </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_objects1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_objects2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_objects3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="js_objects.asp" style="font-size:80%;text-decoration:underline;">Go to JS Objects tutorial</a></div></div><div><div onclick="openmenuitems(4)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Events </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_events1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_events2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_events3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="js_events.asp" style="font-size:80%;text-decoration:underline;">Go to JS Events tutorial</a></div></div><div><div onclick="openmenuitems(5)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Strings </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings5"><i class="fa fa-check"></i> Exercise 5</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings6"><i class="fa fa-check"></i> Exercise 6</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings7"><i class="fa fa-check"></i> Exercise 7</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings8"><i class="fa fa-check"></i> Exercise 8</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_strings9"><i class="fa fa-check"></i> Exercise 9</a><a class="exbtn" href="js_strings.asp" style="font-size:80%;text-decoration:underline;">Go to JS Strings tutorial</a></div></div><div><div onclick="openmenuitems(6)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Arrays </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays5"><i class="fa fa-check"></i> Exercise 5</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays6"><i class="fa fa-check"></i> Exercise 6</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays7"><i class="fa fa-check"></i> Exercise 7</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_arrays8"><i class="fa fa-check"></i> Exercise 8</a><a class="exbtn" href="js_arrays.asp" style="font-size:80%;text-decoration:underline;">Go to JS Arrays tutorial</a></div></div><div><div onclick="openmenuitems(7)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Dates </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dates1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dates2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dates3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dates4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="js_dates.asp" style="font-size:80%;text-decoration:underline;">Go to JS Dates tutorial</a></div></div><div><div onclick="openmenuitems(8)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Math </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_math1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_math2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_math3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_math4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="js_math.asp" style="font-size:80%;text-decoration:underline;">Go to JS Math tutorial</a></div></div><div><div onclick="openmenuitems(9)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Comparisons </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_comparisons1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_comparisons2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_comparisons3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_comparisons4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="js_comparisons.asp" style="font-size:80%;text-decoration:underline;">Go to JS Comparisons tutorial</a></div></div><div><div onclick="openmenuitems(10)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Conditions </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_conditions1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_conditions2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="js_conditions.asp" style="font-size:80%;text-decoration:underline;">Go to JS Conditions tutorial</a></div></div><div><div onclick="openmenuitems(11)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Switch </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_switch1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_switch2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="js_switch.asp" style="font-size:80%;text-decoration:underline;">Go to JS Switch tutorial</a></div></div><div><div onclick="openmenuitems(12)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS Loops </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_loops1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_loops2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_loops3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_loops4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_loops5"><i class="fa fa-check"></i> Exercise 5</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_loops6"><i class="fa fa-check"></i> Exercise 6</a><a class="exbtn" href="js_loop_for.asp" style="font-size:80%;text-decoration:underline;">Go to JS Loops tutorial</a></div></div><div><div onclick="openmenuitems(13)" class="exmenuitemheader"><i style="position:absolute;left:224px;padding-top:4px;" class="fa fa-check"></i>JS HTML DOM </div><div class="exmenulinks"><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html1"><i class="fa fa-check"></i> Exercise 1</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html2"><i class="fa fa-check"></i> Exercise 2</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html3"><i class="fa fa-check"></i> Exercise 3</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html4"><i class="fa fa-check"></i> Exercise 4</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html5"><i class="fa fa-check"></i> Exercise 5</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html6"><i class="fa fa-check"></i> Exercise 6</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html7"><i class="fa fa-check"></i> Exercise 7</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html8"><i class="fa fa-check"></i> Exercise 8</a><a class="exbtn" href="exercise_js.asp?filename=exercise_js_dom_html9"><i class="fa fa-check"></i> Exercise 9</a><a class="exbtn" href="js_htmldom_html.asp" style="font-size:80%;text-decoration:underline;">Go to JS HTML DOM tutorial</a></div></div>
<br>
<br>
<br>
<br>
...
<div id="id01" class="w3-modal" style="z-index:3;">
  <div class="w3-modal-content w3-card-4 w3-center">
    ...
    <div class="w3-container w3-padding">
      <p>This will reset the score of ALL 68 exercises.</p>
...
<div id="id02" class="w3-modal" style="z-index:3;">
  <div class="w3-modal-content w3-card-4 w3-padding w3-center">
    ...
    <div class="w3-container w3-padding">
      <h3>You have finished all 68&nbsp;JS exercises.</h3>
      <p>Share your score on facebook:</p>
      
      <a href="https://www.facebook.com/sharer.php?u=https://www.w3schools.com/JS/exercise.asp" target="_blank" title="Facebook"><span style="color:#3B5998;" class="fa fa-facebook-square fa-2x"></span></a>
      <br>
      <br>
      <br>
      <br>
