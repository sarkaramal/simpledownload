...
</p><p>The sequence <strong>\'</strong>&nbsp; inserts a single quote in a string:</p><p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
</p><p>The sequence <strong>\\</strong>&nbsp; inserts a backslash in a string:</p><p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
</p><p>Six other escape sequences are valid in JavaScript:</p>
<table class="w3-table-all notranslate">
<tr>
  <th width="25%">Code</th>
  <th>Result</th>
