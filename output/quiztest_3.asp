...
<a target="_top" href="quiztest.asp?Qtest=HTML">Quiz HTML</a>
<a target="_top" href="quiztest.asp?qtest=CSS">Quiz CSS</a>
<a target="_top" href="quiztest.asp?qtest=JavaScript">Quiz JavaScript</a>
<a target="_top" href="quiztest.asp?qtest=Bootstrap">Quiz Bootstrap</a>
<a target="_top" href="quiztest.asp?qtest=jQuery">Quiz jQuery</a>
<a target="_top" href="quiztest.asp?qtest=PHP">Quiz PHP</a>
<a target="_top" href="quiztest.asp?qtest=SQL">Quiz SQL</a>
<a target="_top" href="quiztest.asp?qtest=XML">Quiz XML</a>
...
<div class="w3-padding w3-light-grey">
    ...
    <form role="form" name="quizform" action="quiztest.asp?qtest=SQL" method="post">
    <input type="hidden" name="starttime" value="9/21/2018 6:14:29 AM">
    <input type="hidden" name="answers" value="0000000000000000000000000" size="25">
    <input type="hidden" name="qnumber" value="1" size="25">
    <div class="radio"><label><input type="radio" name="quiz" id="2" value="2"> Structured Question Language</label></div><div class="radio"><label><input type="radio" name="quiz" id="3" value="3"> Strong Question Language</label></div><div class="radio"><label><input type="radio" name="quiz" id="1" value="1"> Structured Query Language</label></div>
    <br>
