...
<h1>The JavaScript <strong>this</strong> Keyword</h1>
...
<p>In a function definition, <strong>this</strong> refers to the "<strong>owner</strong>" of the function.</p>
<p>In the example above, <strong>this</strong> refers to the <strong>person</strong> object.</p>
<p>The <strong>person</strong> object "owns" the <strong>fullName</strong> method.</p>

<hr>
<h2>Default Binding</h2>
<p>When used alone, <strong>this</strong> refers to the <strong>Global object</strong>.</p>
<p>In a browser the Global object is [<strong>object Window</strong>]:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var x = this; 
...
<p>When used in a function, <strong>this</strong> refers to the <strong>Global object</strong>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>In strict mode, <strong>this</strong> will be <strong>undefined</strong>,
because strict mode does not allow default binding:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>In these examples, <strong>this</strong> is the <strong>person</strong> object
...
<p>In other words: <strong>this.firstName</strong> means the <strong>firstName</strong> property of 
<strong>this</strong> (person) object.</p>  

<hr>
<h2>Explicit Function Binding</h2>
<p>The <strong>call()</strong> and <strong>apply()</strong> methods are predefined JavaScript methods.</p>
...
<p>In this example, when calling person1.fullName with person2 as argument, <strong>this</strong> will refer to person2, even if it is a method of person1:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var person1 = {<br>
